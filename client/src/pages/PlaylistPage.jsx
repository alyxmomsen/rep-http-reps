            ...
            <div className="flex" style={{ gap: '18px' }}>
                ...
                >
                    {videos.map((video) => (
                        ...
                        >
                            <div
                                style={{ fontWeight: 'bold', color: 'bisque' }}
                            >
                ...
                >
                    {selectedVideo ? (
                        <div className="flex flex--col flex--gap-1">
                            <h3
                                style={{ color: 'bisque', margin: '0 0 9px 0' }}
                            >
                            ...
                            {/* Выбор качества */}
                            {selectedVideo.files &&
                                Object.keys(selectedVideo.files).length > 0 && (
                                    <div
                                        className="flex flex--gap-1"
                                        style={{ marginBottom: '9px' }}
                                    >
                                        {Object.keys(selectedVideo.files).map(
                                            (quality) => {
                                                const filename =
                                                    selectedVideo.files[quality]
                                                        ?.filesistemFilename;
