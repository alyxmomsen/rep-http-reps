...
const {
    filesSchemaInjectedController,
} = require('../models/validate-strategies.models/files-schema.db-adapter');
const {
    playlistController,
} = require('../models/validate-strategies.models/playlist.schema.model');
const {
    usersController,
} = require('../models/validate-strategies.models/users.strategy.schema');
const {
    videoFilesController,
} = require('../models/validate-strategies.models/video-files.schema.model');
...
dbControllersRouter.set(DATABASE_TABLES.FILES, filesSchemaInjectedController);
