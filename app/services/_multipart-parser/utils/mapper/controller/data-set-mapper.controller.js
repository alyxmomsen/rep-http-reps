...
const {
    BranchActionFactory,
} = require('../model/actions/branch-action/model/branch-action.model');
const {
    BTypeActionFactory,
} = require('../model/actions/leaf-action/model/leaf-action.mode');
...
module.exports = {
    dataSetProcessorFactory: dataSetProcessorFactory /* , Actions */,
};
